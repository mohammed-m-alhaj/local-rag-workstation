...
async def embed_batch_with_retry(
    ...
    while True:
        ...
        try:
            ...
            if google_exc and isinstance(exc, google_exc.ResourceExhausted):
                is_retryable = True
                is_429 = True
                metrics.record_429()
                retry_after = _extract_retry_after(exc)
            elif google_exc and isinstance(exc, google_exc.GoogleAPIError):
            ...
            # HTTP / OpenAI / Local server errors
                ...
                if exc.response.status_code == 429:
                    ...
                    metrics.record_429()
                retry_after = _extract_retry_after(exc)
            elif isinstance(exc, (httpx.RequestError, ConnectionError, TimeoutError, OSError)):
                is_retryable = True
